...
HD_PWD='C:/Users/flap9/MyData/Workspaces/hw-syn-lab/lab_6/lab_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_receive.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_receive.tcl -notrace
