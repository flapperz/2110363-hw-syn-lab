...
HD_PWD='C:/Users/flap9/MyData/Workspaces/hw-syn-lab/lab_5/lab_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_nanolada_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3_nanolada_system.tcl -notrace
