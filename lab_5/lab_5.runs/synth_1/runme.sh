...
HD_PWD='C:/Users/flap9/MyData/Workspaces/hw-syn-lab/lab_5/lab_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3_nanolada_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3_nanolada_system.tcl
