...
wire [2:0] mod_alu_ops;

assign mod_alu_ops = (opcode==6'b000001) ? reserved[2:0]: alu_ops;
...
alu		ALU(data_S,z_new,c_new,A,B_selected,c_flag,mod_alu_ops);
